...
<p> <a href="woman.php?logout='1'" style="color: red;"><button class="w3-button w3-black">logout </button></a></p>
    ...
    <div class="padding">
        <div class="social-s w3-panel ">
            ...
            Welcome to the Women Health Diagnostic. Here you can diagnose the symptoms you are experiencing and identify possible health conditions by answering a series of questions. But first, you have to choose the area in your body where the symptoms you are complaining about appear:
...
<img id="s-avatar" src="./imge/woman.jpg"  data-originalimg="./imge/woman.jpg" alt="male avatar">
<img id="belly" src="./imge/s-woman-belly.jpg" class="s-display-away" alt="belly">
<img id="chest_and_back" src="./imge/s-woman-chest.jpg" class="s-display-away" alt="chest and back">
<img id="ear_nose_throat" src="./imge/s-woman-ear-nose-throat.jpg" class="s-display-away" alt="ear nose throat">
<img id="head_and_nick" src="./imge/s-woman-head-nick.jpg" class="s-display-away" alt="head and nick">
...
<area  coords="101,106,98,117,97,123,99,128,99,134,99,141,100,146,101,149,72,187,44,156,49,142,48,132,49,120,47,110,45,106" >
            ...
            <div class="symptom part-select part-select-text column list-select-part">
                <h1 class="bold b-border text-lg-start text-md-start text-sm-start">Choosing a part of a woman </h1>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item   text-lg-start text-md-start text-sm-start " ><a href="http://localhost/xampp/help/woman/header/Hair loss.php" >Hair loss in women</a></li><li class="symptom-item  text-lg-start text-md-start text-sm-start  "><a href="http://localhost/xampp/help/woman/header/Headache.php" >Headache</a></li><li class="symptom-item  text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/header/Dizziness.php" >Dizziness when standing</a></li><li class="symptom-item  text-lg-start text-md-start text-sm-start  "><a href="http://localhost/xampp/help/woman/header/Neck pain.php" >Neck pain</a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/ear nose throat/Chronic cough.php" >Chronic cough</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/ear nose throat/Sore throat.php" >Sore throat</a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/chest and back/chest pain.php" >chest pain</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/chest and back/heart palpitations.php" >heart palpitations</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/chest and back/Shortness of breath in adults.html" >Shortness of breath in adults</a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item   text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/abdomen/pain in the abdomen.php"> pain in the abdomen</a></li><li class="symptom-item   text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/woman/abdomen/muscle weakness.php">muscle weakness</a></li></ul>
                </div>
            </div>
