...
<p> <a href="woman.php?logout='1'" style="color: red;"><button class="w3-button w3-black">logout </button></a></p>
    ...
    <div class="padding">
        <div class="social-s w3-panel ">
            ...
            Welcome to the Diagnostic of Health Symptoms for Children. Here you can diagnose the symptoms your child suffers from and identify possible health conditions by answering a series of questions. But first you have to choose the area where the symptoms your child complains about:
...
<img id="s-avatar" src="./imge/child_2.jpg"  data-originalimg="./imge/child_2.jpg" alt="male avatar">
<img id="belly" src="./imge/child_belly_2.jpg" class="s-display-away" alt="belly">
<img id="chest_and_back" src="./imge/child_chest_and_back_2.jpg" class="s-display-away" alt="chest and back">
<img id="ear_nose_throat" src="./imge/child_ear_nose_throat_2.jpg" class="s-display-away" alt="ear nose throat">
<img id="head_and_nick" src="./imge/child_head_and_nick_2.jpg" class="s-display-away" alt="head and nick">
...
<area  coords="101,106,98,117,97,123,99,128,99,134,99,141,100,146,101,149,72,187,44,156,49,142,48,132,49,120,47,110,45,106" >
            ...
            <div class="symptom part-select part-select-text column list-select-part">
                <h1 class="bold b-border text-lg-start text-md-start text-sm-start">Choosing a part of a child </h1>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item  text-lg-start text-md-start text-sm-start  "><a href="http://localhost/xampp/help/man/header/Headache.php" >Headache in children</a></li><li class="symptom-item  text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/man/header/Dizziness.php" >Head injury in children</a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/man/ear nose throat/Sore throat.php" >Sore throat</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/man/ear nose throat/Sore throat.php" >Treating allergic rhinitis in children
</a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/man/chest and back/chest pain.html" >Asthma treatment</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/man/chest and back/heart palpitations.php" >Cough in children
</a></li><li class="symptom-item text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/man/chest and back/Shortness of breath in adults.php" >Shortness of breath </a></li></ul>
                </div>
            </div>
...
<ul class="parts list" id="symptomsUl"><li class="symptom-item   text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/child/abdomen/pain in the abdomen.php"> pain in the abdomen</a></li><li class="symptom-item   text-lg-start text-md-start text-sm-start "><a href="http://localhost/xampp/help/man/abdomen/muscle weakness.php">Vomiting or nausea in children</a></li></ul>
                </div>
            </div>
