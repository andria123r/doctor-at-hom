...
$db = mysqli_connect('localhost', 'root', '', 'db_user_activation');
...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO registered_users (username, email, password ,firstname,lastname,gender,age) 
  			  VALUES('$username', '$email', '$password' ,' $firstName',' $lastName' ,'$gender','$date')";
